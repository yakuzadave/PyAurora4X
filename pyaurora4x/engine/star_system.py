...
class StarSystemGenerator:
    ...
    def generate_system(self, system_id: Optional[str] = None) -> StarSystem:
        ...
        habitable_zone_inner, habitable_zone_outer = self._calculate_habitable_zone(star_luminosity)
    ...
    def _determine_planet_type(self, distance_au: float, star_luminosity: float) -> PlanetType:
        """
        ...
        habitable_inner, habitable_outer = self._calculate_habitable_zone(star_luminosity)
    ...
    def _calculate_surface_temperature(self, distance_au: float, star_luminosity: float) -> float:
        """
    ...
    def _generate_system_name(self) -> str:
        ...
        suffixes = [
            "Centauri", "Draconis", "Orionis", "Cygni", "Andromedae", "Cassiopeiae",
            "Lyrae", "Aquilae", "Bootis", "Virginis", "Leonis", "Ursae",
            "Cephei", "Persei", "Aurigae", "Geminorum"
        ]
